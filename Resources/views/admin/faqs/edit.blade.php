    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="box box-primary">
                <div class="box-body">
                    {!! Form::normalSelect('category_id', trans('faq::faqs.form.category_id'), $errors, $categoryLists, isset($faq->category->id) ? $faq->category->id : '') !!}
                    <div class="form-group">
                    {!! Form::normalSelect('status', trans('faq::faqs.form.status'), $errors, $statuses, $faq->status) !!}
                    </div>
                    {!! Form::normalInput('ordering', trans('faq::faqs.form.ordering'), $errors, $faq) !!}
                    <hr/>
                    @mediaSingle('faqImage', $faq, null, trans('faq::faqs.form.image'))
                </div>
            </div>
        </div>
    </div>
